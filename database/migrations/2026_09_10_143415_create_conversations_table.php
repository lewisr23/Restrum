...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('conversations', function (Blueprint $table) {
            ...
            // Denormalised copy of the listing's seller at creation time. The
            // seller side of a thread is implied by the listing, but copying
            // it here avoids a join on every inbox load and survives the
            // listing being reassigned later.
